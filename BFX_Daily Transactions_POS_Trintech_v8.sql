...
/****** Object:  StoredProcedure [dbo].[sp_Reporting_DailyTransactions_Trintech_POS_v8]    Script Date: 7/26/2016 9:33:51 AM ******/
SET ANSI_NULLS ON
GO
...
;WITH
	CTE_PaymentData
		AS (
			...
			LEFT JOIN [TSI_tactical].[dbo].[Staging_ReportExclusionStaging] es (NOLOCK) ON es.ReportName = 'BFX_Daily_Transactions_POS_Trintech'
																							AND es.Deleted = 0
